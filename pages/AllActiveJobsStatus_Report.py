...
from app import app, token, get_from_cache, Attribute, HistoricalTimeRequest, historical_data_time, add_to_cache
from app import app
    ...
    if n and n > 0:
        ...
        try:
            ...
            if JobsList:
                ...
                task_results["activeJobs"] = html.Div([
                    html.H1("All Active Jobs Dashboards", style={'text-align': 'center'}), dash_table.DataTable(
                        id='Attributes ID',
                ...
                return task_results["activeJobs"]

            else:
                if task_results["activeJobs"]:
                    return task_results["activeJobs"]
                else:
                    print("JobsList is empty.")
